...
pub(crate) fn parse_json(data: &str) -> Value {
...
pub(crate) fn enabled_buttons_value(
    value: &Value,
...
/// 字符串 → CursorIcon
pub(crate) fn cursor_icon_value(
    value: &str,
) -> std::result::Result<tao::window::CursorIcon, String> {
    Ok(match value {
        ...
        "noDrop" => tao::window::CursorIcon::NoDrop,
        "grab" => tao::window::CursorIcon::Grab,
        "grabbing" => tao::window::CursorIcon::Grabbing,
        "allScroll" => tao::window::CursorIcon::AllScroll,
        "zoomIn" => tao::window::CursorIcon::ZoomIn,
        "zoomOut" => tao::window::CursorIcon::ZoomOut,
        "eResize" => tao::window::CursorIcon::EResize,
        "nResize" => tao::window::CursorIcon::NResize,
        "neResize" => tao::window::CursorIcon::NeResize,
        "nwResize" => tao::window::CursorIcon::NwResize,
        "sResize" => tao::window::CursorIcon::SResize,
        "seResize" => tao::window::CursorIcon::SeResize,
        "swResize" => tao::window::CursorIcon::SwResize,
        "wResize" => tao::window::CursorIcon::WResize,
        "ewResize" => tao::window::CursorIcon::EwResize,
        "nsResize" => tao::window::CursorIcon::NsResize,
        "neswResize" => tao::window::CursorIcon::NeswResize,
        "nwseResize" => tao::window::CursorIcon::NwseResize,
        "colResize" => tao::window::CursorIcon::ColResize,
        "rowResize" => tao::window::CursorIcon::RowResize,
        other => return Err(format!("invalid cursor icon '{}'", other)),
    })
}

/// 字符串 → ResizeDirection
pub(crate) fn resize_direction_value(
    value: &str,
) -> std::result::Result<tao::window::ResizeDirection, String> {
    Ok(match value {
...
pub(crate) fn progress_value(
    value: &Value,
) -> std::result::Result<tao::window::ProgressBarState, String> {
...
pub(crate) fn window_constraints_value(
    value: &Value,
) -> std::result::Result<tao::window::WindowSizeConstraints, String> {
    let object = value
        .as_object()
        .ok_or_else(|| "constraints must be an object".to_string())?;
    let mut c = tao::window::WindowSizeConstraints::default();
    if let Some(v) = object.get("minWidth").and_then(Value::as_f64) {
        c.min_width = Some(tao::dpi::LogicalUnit::new(v).into());
    }
    if let Some(v) = object.get("minHeight").and_then(Value::as_f64) {
        c.min_height = Some(tao::dpi::LogicalUnit::new(v).into());
    }
    if let Some(v) = object.get("maxWidth").and_then(Value::as_f64) {
        c.max_width = Some(tao::dpi::LogicalUnit::new(v).into());
    }
    if let Some(v) = object.get("maxHeight").and_then(Value::as_f64) {
        c.max_height = Some(tao::dpi::LogicalUnit::new(v).into());
    }
    Ok(c)
}

/// JSON → Option<UserAttentionType>
pub(crate) fn user_attention_value(
    value: &Value,
) -> std::result::Result<Option<tao::window::UserAttentionType>, String> {
    if value.is_null() {
        return Ok(None);
    }
...
/// JSON → HeaderMap
pub(crate) fn headers_from_value(
    value: &Value,
) -> std::result::Result<wry::http::HeaderMap, String> {
